...
export default {
  ...
  modpackExport: {
    ...
    stageLookup: 'Identifying file fingerprints',
    stageManifest: 'Generating config files',
    stagePacking: 'Packing game files: {file}',
    cancelExport: 'Cancel',
    cancelConfirm: 'Cancel the export?',
    exportCancelled: 'Export cancelled',
    exportSaved: '✓ Export complete',
    exportSavedTo: '✓ Export complete (saved to: {path})',
    ...
    selectedSummary: '{count} items · {size}',
    loading: 'Loading file list...',
    loadFailed: 'Failed to load file list',
    retry: 'Retry',
    empty: 'No exportable files',
    fileCount: '{count} items',
    expand: 'Expand',
    collapse: 'Collapse',
    catMods: 'Mods',
    catResourcepacks: 'Resource Packs',
    catShaderpacks: 'Shader Packs',
    catSaves: 'Saves',
  ...
  license: {
    ...
    tokenLabel: 'Licence Token',
    tokenPlaceholder: 'Paste the licence Token provided by the administrator...',
    tokenHint: 'Contact the administrator to get a new licence Token. Enter it and click Activate to verify.',
...
- This software is released under the **GPL-3.0 License**; you may freely use, copy, modify and redistribute it under that licence.
