...
export default {
  ...
  update: {
    ...
    channelSwitchTitle: 'Переключиться на канал {channel}',
    channelSwitchNotice: 'Вы переключаетесь на другой канал выпуска. Это смена канала, а не обычное обновление версии; далее вы будете получать обновления из этого канала.',
  },
  // Активация лицензии
  license: {
