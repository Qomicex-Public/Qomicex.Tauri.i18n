...
Qomicex Launcher（以下簡稱「本軟體」）由 Qomicex 團隊開發並維護。我們重視您的隱私權保護，本政策旨在幫助您了解我們如何收集、使用和保護您的資訊。
...
- **Minecraft** 及相關名稱、標誌、版權均歸 **Mojang Studios / Microsoft** 所有。
- 本軟體不包含 Minecraft 遊戲本體；遊戲資源版權歸其各自所有者所有。
- 使用本軟體即表示您已閱讀並同意《使用者協議》與本《隱私權政策》。
...
| 外掛程式錯誤遙測 | 外掛程式 ID、版本、錯誤類型 | 改善外掛程式生態 | 是 |
...
- **錯誤遙測**：用於改善外掛程式生態穩定性，完全匿名，不含個人身份資訊
- **崩潰報告**：用於診斷和修復軟體問題，在您同意或發生嚴重錯誤時傳送
- **崩潰日誌分享**：當您觸發崩潰分析時，系統會自動將崩潰日誌上傳至 mclo.gs 第三方服務以生成可分享連結
- **版本資訊**：僅用於檢查軟體更新
- **許可證資訊**：僅用於驗證軟體使用授權（僅限 license-required 構建版本）

## 四、資料儲存與保留

- **帳戶資料**：儲存在您的本地裝置上，解除安裝軟體時可選擇刪除
...
| plugins.qomicex.top | 外掛程式商店 | 外掛程式查詢、安裝記錄 | 本政策適用 |

## 七、Cookie 與本地儲存

- 本軟體使用本地儲存（LocalStorage）儲存使用者偏好設定
- 本軟體不使用瀏覽器 Cookie
- 本地儲存資料不會被第三方存取
...
- **存取權**：可隨時查看本地儲存的帳戶資料
- **刪除權**：可隨時刪除本地儲存的帳戶資料
- **控制權**：可在設定中隨時開啟/關閉錯誤自動報告和外掛程式錯誤遙測
- **撤回同意**：可隨時撤回對本隱私權政策的同意

## 十、未成年人保護

本軟體不針對 14 歲以下未成年人收集個人資訊。如果您是未成年人，請在監護人指導下使用本軟體。

## 十一、政策更新

我們可能會不時更新本隱私權政策。更新後的政策將在本軟體內公布。重大變更時，我們會在軟體內通知您。

## 十二、聯繫我們

如有隱私權相關問題，請透過以下方式聯繫我們：
