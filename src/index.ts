...
export { zhCN, zhTW, zhHK, enUS, enGB, jaJP, ruRU }
// 兼容旧导出名（en == en-US）
export { enUS as en }
...
import zhHKGameSettingsDescriptions from './zh-HK/game-settings-descriptions.json'
...
import jaJPGameSettingsDescriptions from './ja-JP/game-settings-descriptions.json'
import ruRUGameSettingsDescriptions from './ru-RU/game-settings-descriptions.json'

export const GAME_SETTINGS_DESCRIPTIONS = {
  'zh-CN': zhCNGameSettingsDescriptions,
  'zh-TW': zhTWGameSettingsDescriptions,
  'zh-HK': zhHKGameSettingsDescriptions,
  'en-US': enUSGameSettingsDescriptions,
  'en-GB': enGBGameSettingsDescriptions,
  'ja-JP': jaJPGameSettingsDescriptions,
  'ru-RU': ruRUGameSettingsDescriptions,
} as const

export {
  zhCNGameSettingsDescriptions,
  zhTWGameSettingsDescriptions,
  zhHKGameSettingsDescriptions,
  enUSGameSettingsDescriptions,
  enGBGameSettingsDescriptions,
  jaJPGameSettingsDescriptions,
  ruRUGameSettingsDescriptions,
}
